...
class Settings:
    ...
    top_list_sku3_batch_concurrency: int = int(os.getenv("TOP_LIST_SKU3_BATCH_CONCURRENCY", "5"))
    ...
    fast_mode: bool = os.getenv("FAST_MODE", "false").lower() in {"1", "true", "yes"}
    seed_create_days_max: int = int(os.getenv("SEED_CREATE_DAYS_MAX", "200"))
    default_create_days_max: int = int(os.getenv("DEFAULT_CREATE_DAYS_MAX", "180"))
